...
class _LogViewState extends State<LogView> {
  ...
  // Digabung: return (emoji, greeting) sekaligus, hindari panggil DateTime.now() 2x
  ...
  // Blob dekorasi header — dulu 3x Container boilerplate yang sama
  ...
  // Border input — dulu diulang 4x di _buildInputDecoration
  ...
  // --- DIALOG TAMBAH & EDIT — digabung jadi satu fungsi ---
                  ...
                  builder: (context, currentLogs, _) {
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(shape: BoxShape.circle, color: _kPurple.withValues(alpha: 0.08)),
                              child: Icon(Icons.auto_stories_rounded, size: 60, color: _kPurple.withValues(alpha: 0.4)),
                            ),
                            const SizedBox(height: 16),
                            Text("Belum ada catatan", style: TextStyle(color: Colors.grey.shade700, fontSize: 16, fontWeight: FontWeight.w700)),
                            const SizedBox(height: 6),
                            Text("Tap tombol + untuk mulai menulis", style: TextStyle(color: Colors.grey.shade400, fontSize: 13)),
                          ],
                        ),
                      );
                    }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Dismissible(
                          key: Key(log.date + index.toString()),
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                const Spacer(),
                                                Text(log.date.substring(0, 10), style: TextStyle(color: Colors.grey.shade400, fontSize: 10)),
                                              ],
                                            ),
                                            const SizedBox(height: 6),
